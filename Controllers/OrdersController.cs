...
namespace FPTBOOK.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Qty,Phone,OrderTime,BookId,UserId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Qty,Phone,OrderTime,BookId,UserId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
